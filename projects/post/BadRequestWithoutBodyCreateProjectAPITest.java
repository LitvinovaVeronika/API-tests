...
public class BadRequestWithoutBodyCreateProjectAPITest extends BaseTest {

    private ExtractableResponse response;

    @Test(timeout = 60000)
    public void postProject_should_badRequest_when_projectUserHeader_and_noRequestBody() {
        response = given()
